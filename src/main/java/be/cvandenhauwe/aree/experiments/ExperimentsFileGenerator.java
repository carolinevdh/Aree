...
public class ExperimentsFileGenerator {
    ...
    public static void generateDescriptors() throws IOException{
        for(int i = 0; i <= 100; i += 5){
            FileWriter writer = new FileWriter("/Users/caroline/Desktop/descriptors/experimentfour" + i + "components.xml");
            writer.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n");
            writer.append("<descriptor>\n");
            writer.append("<configuration>\n"); 
            writer.append("<chain>\n");
            for(int j = 1; j <= i; j++){
                writer.append("<component identifier=\"be.cvandenhauwe.aree.experiments.ExperimentComponent\" hassetup=\"false\" />\n");
            }
            writer.append("</chain>\n");
            writer.append("</configuration>\n");
            writer.append("</descriptor>\n");
